        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/75">
              ...
              <li className="flex items-start gap-2"><MapPin className="mt-0.5 h-4 w-4 text-[var(--color-gold)]" /><span>Near Sai Baba College, Banaras Road, Bhagwanpur, Ambikapur, Surguja (C.G.) 497001</span></li>
            </ul>
