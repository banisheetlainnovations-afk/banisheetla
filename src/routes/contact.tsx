...
import { PageHero } from "@/components/PageHero";a
          ...
          <aside className="space-y-6 lg:col-span-1">
            <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li className="flex items-start gap-3"><MapPin className="mt-0.5 h-5 w-5 text-accent" /><span>Near Sai Baba College, Banaras Road, Bhagwanpur, Ambikapur, Surguja (C.G.), India 497001</span></li>
              </ul>
              <a
            ...
            <div className="overflow-hidden rounded-2xl border border-border">
              <iframe
                title="BSI Location"
                src="https://www.google.com/maps?q=Sai+Baba+College,+Banaras+Road,+Bhagwanpur,+Ambikapur,+Chhattisgarh+497001&output=embed"
