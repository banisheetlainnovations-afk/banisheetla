            ...
            <aside className="space-y-4 lg:col-span-2">
              <div className="rounded-2xl border border-white/15 bg-white/5 p-6 backdrop-blur">
                ...
                <ul className="mt-4 space-y-4 text-sm text-white/85">
                  ...
                  <li className="flex items-start gap-3"><MapPin className="mt-0.5 h-5 w-5 text-[var(--color-gold)]" /><span>Near Sai Baba College, Banaras Road, Bhagwanpur, Ambikapur, Surguja (C.G.), India 497001</span></li>
                </ul>
              </div>
